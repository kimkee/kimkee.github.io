...
<?php include("../_include/_head.php"); ?>
						...
						<div class="classHead"><img src="/work/edda/gameInfo/images/classImgD1.gif" alt="워리어" /></div>
						...
						<div class="classTab">
							...
							<table border="1" cellpadding="0" cellspacing="0" class="list">
								...
								<tr>
									...
									<td><a href="/work/edda/gameInfo/classB2.php"><img src="/work/edda/gameInfo/images/classTabBm2On.gif" alt="아처" /></a></td>
								</tr>
								<tr>
						...
						<div class="cMenu">
							<ul>
								<li><a href="javascript:movie_change('아처','마이티샷','classImgDm1')"><img id="classImgDm1" src="/work/edda/gameInfo/images/classImgDm1On.gif" alt="마이티샷" /></a></li>
								<li><a href="javascript:movie_change('아처','배틀애로우','classImgDm2')"><img id="classImgDm2" src="/work/edda/gameInfo/images/classImgDm2.gif" alt="배틀애로우" /></a></li>
								<li><a href="javascript:movie_change('아처','트리플애로우','classImgDm3')"><img id="classImgDm3" src="/work/edda/gameInfo/images/classImgDm3.gif" alt="트리플애로우" /></a></li>
								<li><a href="javascript:movie_change('아처','파이어캔비지','classImgDm4')"><img id="classImgDm4" src="/work/edda/gameInfo/images/classImgDm4.gif" alt="파이어캔비지" /></a></li>
							</ul>
						</div>
                        <script type="text/javascript">
							function movie_change(str1,str2,img){
								document.getElementById('classImgDm1').src="/work/edda/gameInfo/images/classImgDm1.gif";
								document.getElementById('classImgDm2').src="/work/edda/gameInfo/images/classImgDm2.gif";
								document.getElementById('classImgDm3').src="/work/edda/gameInfo/images/classImgDm3.gif";
								document.getElementById('classImgDm4').src="/work/edda/gameInfo/images/classImgDm4.gif";
						...
						<div class="classMovie">
							<!--<script type="text/javascript">flashWrite('/swf/player.swf',616,482,'mainEvent','#ffffff','file=/swf/classMovie/아처/마이티샷.flv&amp;image=/swf/classMovie/아처/마이티샷.jpg','transparent','false')</script>-->
                            <iframe id="moviePlay2" name="moviePlay2" src="/work/edda/gameInfo/movie_player.php?str1=아처&str2=마이티샷" frameborder="0" allowtransparency="true" style=" background-color:transparent; overflow:hidden; width:616px; height:482px"></iframe>
						</div>
