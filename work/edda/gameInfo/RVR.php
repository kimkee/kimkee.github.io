...
<?php include("../_include/_head.php"); ?>
						...
						<div class="tab"><img src="/work/edda/gameInfo/images/tabSPTab05.gif" alt="" border="0" usemap="#tab" /></div>
						<map name="tab" id="tab">
						...
						<div><img src="/work/edda/gameInfo/images/RVRIMG.jpg" alt="" border="0" usemap="#RVRIMG" />
<map name="RVRIMG" id="RVRIMG"><area shape="rect" coords="8,944,120,972" href="/work/edda/gameInfo/halidom.php" alt="성물전자세히보기" />
</map></div>
