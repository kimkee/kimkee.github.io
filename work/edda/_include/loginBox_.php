<% '이용동의 체크 %>
<!--# include virtual="/topbar/uin_layer.php"); ?>
<%
IF Login_ID ="" THEN
%>
...
ELSE
%>
<script language="javascript" src="/work/edda/share.js"></script>
<script language="javascript">
function playGame() {
	self.location.href="/work/edda/etc/gaming.php";
}
</script>
...
<div class="logoutBox">
	<div class="name"><%=Login_ID%>포티아님이시다 <span class="size11 normal">님 반갑습니다.</span></div>
