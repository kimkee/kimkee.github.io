...
<?php include("../_include/_head.php"); ?>		
            ...
            <%
                        ...
                        RedirectURL = "/community/wishList.php"
						%>
						<!--#include virtual="/_board/view.php"); ?>	
						
						<%'<!--#include virtual="/_board/linkPage.php"); ?>	%>
						<%
						if Login_ID <> writer_ID then 
							response.redirect "wishList.php"
						end if 
						%>
<div class="btnList aRight"><%IF Login_ID = writer_ID THEN%><a href="/work/edda/community/wishWrite.php?board_idx=<%=board_idx%>&idx=<%=article_idx%>"><img src="/work/edda/images/board/btnModify.gif" alt="수정하기" /></a> <img src="/work/edda/images/board/btnDelete.gif" alt="삭제하기" style="cursor:pointer" onclick="go_del();" /><%END IF%> <a href="/work/edda/community/wishList.php"><img src="/work/edda/images/board/btnList.gif" alt="목록보기" /></a></div>
                        ...
                        <input type="hidden" name="ReturnURL" value="/community/wishList.php" />
