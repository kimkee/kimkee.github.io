...
<?php include("../_include/_head.php"); ?>		
						...
						<div class="headTit">
							<div class="tit"><img src="/work/edda/community/images/subTit04.gif" alt="유저스크린샷" /></div>
							<div class="location">Home &gt; 커뮤니티 &gt; 유저스크린샷</div>
						</div>

						<!--#include virtual="/_board/view.php"); ?>	
						
						<!--#include virtual="/_board/linkPage.php"); ?>	
						<div class="btnList aRight"><%IF Login_ID = writer_ID THEN%><a href="/work/edda/community/userSSWrite.php?board_idx=<%=board_idx%>&idx=<%=article_idx%>"><img src="/work/edda/images/board/btnModify.gif" alt="수정하기" /></a> <a href="javascript:;" onclick="go_del();"><img src="/work/edda/images/board/btnDelete.gif" alt="삭제하기" /></a><%END IF%> <a href="/work/edda/community/userSSList.php"><img src="/work/edda/images/board/btnList.gif" alt="목록보기" /></a></div>
...
<?php include("../_include/_foot.php"); ?>	
                        ...
                        <input type="hidden" name="ReturnURL" value="/community/userSSList.php" />
