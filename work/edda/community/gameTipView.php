...
<?php include("../_include/_head.php"); ?>		
                        ...
                        RedirectURL = "/community/gameTip.php"
						%>
						<!--#include virtual="/_board/view.php"); ?>	
						
						<!--#include virtual="/_personal/profileBoard.php"); ?>
						
						<!--#include virtual="/_board/linkPage.php"); ?>	
						<div class="btnList aRight"><%IF Login_ID = writer_ID THEN%><a href="/work/edda/community/gameTipWrite.php?board_idx=<%=board_idx%>&idx=<%=article_idx%>"><img src="/work/edda/images/board/btnModify.gif" alt="수정하기" /></a> <a href="javascript:;" onclick="go_del();"><img src="/work/edda/images/board/btnDelete.gif" alt="삭제하기" /></a><%END IF%> <a href="/work/edda/community/gameTip.php"><img src="/work/edda/images/board/btnList.gif" alt="목록보기" /></a></div>
...
<?php include("../_include/_foot.php"); ?>
                        ...
                        <input type="hidden" name="ReturnURL" value="/community/gameTip.php" />
