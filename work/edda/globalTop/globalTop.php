...
<div class="globalTopWrap">
	<div class="globalTop">
		<ul class="gamelink">
			<li><a href="javascript:web_go('1');" onmouseover="faBan('2');" onmouseout="faBanOff();"><img src="/work/edda/images/globalTop/globalTopLink2.gif" alt="아이리스온라인" /></a></li>
			<li><a href="javascript:web_go('3');" onmouseover="faBan('3');" onmouseout="faBanOff();"><img src="/work/edda/images/globalTop/globalTopLink3.gif" alt="에다전설" /></a></li>
			<li><a href="javascript:web_go('2');" onmouseover="faBan('1');" onmouseout="faBanOff();"><img src="/work/edda/images/globalTop/globalTopLink1.gif" alt="엔젤러브" /></a></li>
			<li><a href="javascript:web_go('5');" onmouseover="faBan('5');" onmouseout="faBanOff();"><img src="/work/edda/images/globalTop/globalTopLink5.gif" alt="루나플러스" /></a></li>
		</ul>
		...
		<div class="bannerBox" id="faBanner1" style="display:none; left:80px;" onmouseover="faBan('1');" onmouseout="faBanOff();">
			...
			<div class="top"></div>
			<div class="ctn">
				<div class="img"><a href="javascript:web_go('2');"><img src="/work/edda/images/globalTop/globalTopBan1.jpg" alt="엔젤러브온라인" /></a></div>
		...
		<div class="bannerBox" id="faBanner2" style="display:none" onmouseover="faBan('2');" onmouseout="faBanOff();">
			...
			<div class="top"></div>
			<div class="ctn">
				<div class="img"><a href="javascript:web_go('1');"><img src="/work/edda/images/globalTop/globalTopBan2.jpg" alt="아이리스온라인" /></a></div>
		...
		<div class="bannerBox" id="faBanner3" style="display:none; left:5px;" onmouseover="faBan('3');" onmouseout="faBanOff();">
			...
			<div class="top"></div>
			<div class="ctn">
				<div class="img"><a href="javascript:web_go('3');"><img src="/work/edda/images/globalTop/globalTopBan3.jpg" alt="에다전설" /></a></div>
		...
		<div class="bannerBox" id="faBanner4" style="display:none; left:80px;" onmouseover="faBan('4');" onmouseout="faBanOff();">
			...
			<div class="top"></div>
			<div class="ctn">
				<div class="img"><a href="javascript:web_go('4');"><img src="/work/edda/images/globalTop/globalTopBan4.jpg" alt="프로젝트E" /></a></div>
		...
		<div class="bannerBox" id="faBanner5" style="display:none; left:80px;" onmouseover="faBan('5');" onmouseout="faBanOff();">
			...
			<div class="top"></div>
			<div class="ctn">
				<div class="img"><a href="javascript:web_go('5');"><img src="/work/edda/images/globalTop/globalTopBan5.jpg" alt="루나플러스" /></a></div>
				<div class="txt">다음 테스트를 기대해 주세요!</div>
			</div>
			<div class="bot"></div>
		</div>
	...
	<div class="family">
		...
		<div class="banner"><a href="http://edda.enpang.com/"><img src="/work/edda/images/globalTop/banner_22.jpg" alt="에다전설" /></a></div>
