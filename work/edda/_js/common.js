...
//리플달기 팝업
function popReple() {
  window.open('/work/edda/community/popReple.php','popReple','scrollbars=no,width=489,height=235,left=100,top=100');
}

//리플달기 팝업
function popFanpageReg() {
  window.open('/work/edda/community/popFanpageReg.php','popFanpageReg','scrollbars=no,width=569,height=492,left=100,top=100');
}
