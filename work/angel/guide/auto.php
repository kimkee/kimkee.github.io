<?php include("../guide/_head.php"); ?>	
					...
					<div class="ctnBox">
						...
						<div class="ctn">
							<!-- 컨텐츠시작 -->
							<h4 class="gudTab"><img src="/work/angel/guide/images/autoIMG01.gif" alt="" width="610" height="70" border="0" /></h4>
							<p><img src="/work/angel/guide/images/autoIMG02.jpg" alt="" /></p>
							<!-- 컨텐츠끝 //-->
						</div>
						<div class="bot"></div>
					</div>
