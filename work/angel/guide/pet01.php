<?php include("../guide/_head.php"); ?>	
					...
					<div class="ctnBox">
						...
						<div class="ctn">
							<!-- 컨텐츠시작 -->
							<h4 class="gudTab"><img src="/work/angel/guide/images/pet01IMG01.gif" alt="" width="610" height="70" border="0" usemap="#Map" />
								<map name="Map" id="Map">
							...
							<p><img src="/work/angel/guide/images/pet01IMG02.jpg" alt="" border="0" /></p>
							<!-- 컨텐츠끝 //-->
						</div>
						<div class="bot"></div>
					</div>
