...
<link href="/work/angel/_css/community.css" rel="stylesheet" type="text/css" />
<script type="text/javascript"	 src="/work/angel/_js/common.js"></script>
</head>
<body>
<?php include("../_include/globalTop.php"); ?>	
<div id="subWrap">
  <div id="subComunityBg">
    <div id="subComunity">
      <?php include("../_include/subTop.php"); ?>	
      <div id="center">
        <div class="lnb">
          <?php include("../_include/loginBox.php"); ?>	
          <?php include("../_include/menuCommunity.php"); ?>	
          <?php include("../_include/bannerSub.php"); ?>	
        </div>
		<hr />
        <div class="contents">