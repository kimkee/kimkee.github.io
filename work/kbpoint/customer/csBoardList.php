...
<div class="csWrap">
    <div class="csCenter">
        ...
        <div class="mainCsArea">
            ...
            <div class="rightArea">
                <div class="csSubTopVisual"><img src="/work/kbpoint/images/customer/csBoardTopVisual.jpg" alt="공지사항" /></div>
            	<div class="bbsHead">열린게시판</div>
            	...
            	<!-- 공지 리스트 -->
                <?php include("../customer/bbsSch.php"); ?>
                <table cellspacing="0" border="1" class="bbsList csBbsLsit">
                    ...
                    <tbody>
                        <tr>
                            <td class="bNum">12</td>
                            <td class="bTit"><a href="/work/kbpoint/customer/csBoardView.php">선물추천해주세요! 응모합니다....</a></td>
                            <td class="bName">관리자</td>
                            <td class="bDate">2011.12.25</td>
                            <td class="bHit"><a href="#"><img src="/work/kbpoint/images/customer/icoFile.gif" alt="첨부파일" width="12" height="12" /></a></td>
                            <td class="bHit">815</td>
                        </tr>
                        <tr>
                            <td class="bNum">12</td>
                            <td class="bTit"><img src="/work/kbpoint/images/customer/icoRe.gif" alt="답변" /> <a href="#">답변입니다.</a></td>
                            <td class="bName">관리자</td>
                            <td class="bDate">2011.12.25</td>
                            <td class="bHit"><a href="#"><img src="/work/kbpoint/images/customer/icoFile.gif" alt="첨부파일" width="12" height="12" /></a></td>
                            <td class="bHit">815</td>
                ...
                <div class="btnList">
                    <div class="right"><a href="csBoardWrite.php"><img alt="글쓰기" src="/work/kbpoint/images/customer/btnWrite.gif" /></a></div>
                </div>
