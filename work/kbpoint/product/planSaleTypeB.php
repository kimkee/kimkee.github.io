...
<div class="subWrap">
    <div class="subCenter">
        ...
        <div class="planSaleTop"><img src="/work/kbpoint/images/planSaleImg2.jpg" alt="기획전이미지" width="910" /></div>
        ...
        <div class="mainShopArea Depth3Area">
            ...
            <div class="ctn3Depth">
				...
				<!-- 아이템리스트 3개씩 -->
                <div class="ItemList3Depth itemListPlanSaleTypeB">
                    <div class="itemBoxWrap">
                        <?php include("../product/itemBox.php"); ?>
                        <?php include("../product/itemBox.php"); ?>
                        <?php include("../product/itemBox.php"); ?>
                        <div class="itemLine"></div> <!-- 3마다 줄바꿈 -->
                        <?php include("../product/itemBox.php"); ?>
                        <?php include("../product/itemBox.php"); ?>
                        <?php include("../product/itemBox.php"); ?>
                        <div class="clear"></div>
