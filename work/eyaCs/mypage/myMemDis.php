<?php include("../_include/_head.php"); ?>
			...
			<div class="safBox" style="padding-bottom:20px; margin-bottom:20px;">
				<div style="width:400px; margin:auto; margin-bottom:30px; line-height:18px; text-align:center"><strong>홍길동</strong> 계정이 <span class="tcOrange size11">2009년 10월 10일 00시에 탈퇴 처리</span>됩니다.<br />
					<strong class="tcOrange">탈퇴 취소를 진행 하시겠습니까?</strong></div>
