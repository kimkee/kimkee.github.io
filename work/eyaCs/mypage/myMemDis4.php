<?php include("../_include/_head.php"); ?>
			...
			<p style="padding:0 0 0 10px; line-height:18px; margin-bottom:20px;">회원탈퇴 신청이 접수되면 탈퇴취소 신청이 없을 경우 신청 15일 후 계정 및 게임정보가 자동 삭제됩니다. 
				<br />
				또한 신청 즉시 게임접속과 홈페이지 접속이 차단됨으로 신중한 선택을 해 주시기 바랍니다.
