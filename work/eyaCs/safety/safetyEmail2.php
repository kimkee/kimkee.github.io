<?php include("../_include/_head.php"); ?>
			...
			<div class="size11 aCenter tcOrange" style="letter-spacing:-1px; padding:30px 0">위 이메일주소가 등록되는 것을 <strong>차단합니다.</strong></div>
			
			<div class="btnList"><span class="button large orange"><a href="/work/eyaCs/safety/safetyEmail3.php"><img src="/work/eyaCs/images/board/btnCheck.png" alt="" />인증 후 차단</a></span>
