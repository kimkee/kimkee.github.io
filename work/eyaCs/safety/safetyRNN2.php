<?php include("../_include/_head.php"); ?>
			...
			<div class="safBox" style="padding-bottom:20px; margin-bottom:20px;">
				<table border="1" cellspacing="0" class="dTable3" style="margin:auto; margin-bottom:30px; width:250px">
					<tr>
						<th><img src="/work/eyaCs/images/main/bul03.gif" alt="" width="11" height="10" /> 이름</th>
						<td> <span style="color: #CCCCCC; margin-right:20px;">|</span>  홍길동 </td>
					</tr>
					<tr>
						<th><img src="/work/eyaCs/images/main/bul03.gif" alt="" width="11" height="10" /> 주민등록번호</th>
						<td> <span style="color: #CCCCCC; margin-right:20px;">|</span> 090909 - ****** </td>
					</tr>
				</table>
				<div class="size11 aCenter">본인 역시 회원가입 또는 아이디 추가가 되지 않으오니 회원가입을 원할 경우 회원가입 차단을 해지 후 회원가입이 가능합니다.</div>
			</div>
			...
			<div class="tcOrange aCenter" style="margin-bottom:30px;">위 주민번호로 이야소프트에 회원가입 되는 것을 <strong>차단합니다.</strong></div>
			
			<div class="btnList"><span class="button large orange"><a href="/work/eyaCs/safety/safetyRNN3.php">인증 후 차단</a></span> <span class="button large"><a href="#">취소</a></span></div>
