<?php include("../_include/_head.php"); ?>
			...
			<div class="safBox" style="padding-bottom:20px; margin-bottom:20px;">
				...
				<div class="size11" style="letter-spacing:-1px; line-height:18px; padding:0 20px">본인 역시 회원가입 시 해당 핸드폰번호를 사용하지 못하오니 해당 핸드폰번호를 사용하길 원할 경우 핸드폰번호 사용 차단을 해지 후 이용 
					하실 수 있습니다. <br />
				</div>
			</div>
			<div class="size11 aCenter tcOrange" style="letter-spacing:-1px; padding:30px 0">위 핸드폰번호는 현재 <strong>잠금으로 설정</strong>되어 있습니다. <strong>잠금을 해제</strong> 하시겠습니까?</div>
			
			<div class="btnList"><span class="button large orange"><a href="/work/eyaCs/safety/safetyList.php"><img src="/work/eyaCs/images/board/btnCheck.png" alt="" />인증 후 해제</a></span>
