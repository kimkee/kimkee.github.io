...
<?php include("../_include/_head.php"); ?>
					...
					<div class="btnList">
						<div class="right"><a href="ussWrite.php"><img src="/work/lunaPlus/_board/images/btnModify.gif" alt="수정" /></a> <a href="ussList.php"><img src="/work/lunaPlus/_board/images/btnDelete.gif" alt="삭제" /></a> <a href="ussList.php"><img src="/work/lunaPlus/_board/images/btnList.gif" alt="목록" /></a></div>
					</div>	
