...
<?php include("../_include/_head.php"); ?>
					...
					<table cellspacing="0" border="1" class="bbsList">
						<thead>
							<tr>
								...
								<th class="right"><img src="/work/lunaPlus/_board/images/hImgDate.gif" alt="작성일" /></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td class="bIco">1</td>
								<td class="bTit"><strong><a href="wishView.php">공지사항 보기  입니다.</a></strong></td>
								<td class="bName"><img src="/work/lunaPlus/community/images/discussIco9.gif" alt="" /> 안다리엘</td>
								<td class="bDate">2009.12.25</td>
							</tr>
							<tr>
								<td class="bIco">2</td>
								<td class="bTit"><a href="wishView.php">업데이트 보기 입니다.</a></td>
								<td class="bName"><img src="/work/lunaPlus/community/images/discussIco9.gif" alt="" /> 안다리엘</td>
								<td class="bDate">2009.12.25</td>
							</tr>
						</tbody>
					...
					<div class="btnList">
						<div class="left"><a href="wishList.php"><img src="/work/lunaPlus/_board/images/btnList.gif" alt="목록" /></a></div>
						<div class="right"><a href="wishWrite.php"><img src="/work/lunaPlus/_board/images/btnWrite.gif" alt="글쓰기" /></a></div>
					</div>	
