...
<?php include("../_include/_head.php"); ?>
					...
					<ul class="guideTab">
						...
						<li><a href="character2.php"><img src="/work/lunaPlus/guide/images/characterTab02On.gif" alt="클래스" /></a></li>
						<li><a href="character3.php"><img src="/work/lunaPlus/guide/images/characterTab03.gif" alt="전직" /></a></li>
						<li><a href="character4.php"><img src="/work/lunaPlus/guide/images/characterTab04.gif" alt="스탯효과" /></a></li>
					</ul>
					
					<div><img src="/work/lunaPlus/guide/images/character2IMG.jpg" alt="" /></div>
