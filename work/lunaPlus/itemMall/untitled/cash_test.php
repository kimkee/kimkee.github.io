...
%>	
	<table border="1" width="560px;" cellspacing="0">
		...
		<tr height="30">
			<td colspan="5" align="center"><b>충전내역</b></td>
		</tr>
		<tr height="27">
			<th>충전수단</th>
			<th>충전상품</th>
...
%>
		<tr height="24">
			<td style="text-align:center;"><%=NM_CASH%></td>
			<td style="text-align:center;"><%=NM_GOOD%></td>
			<td style="text-align:center;"><%=FormatNumber(AMT_PAY,0)%> <s>N</s></td>
			<td style="text-align:center;"><%=DT_END%></td>
