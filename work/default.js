...
function artzip() {
  window.open('http://www.artzip.net/','_blank');
}

// 답변팝업
function replayPop() {
  window.open('/reply','reply','scrollbars=yes,width=500,height=500,left=300,top=300');
}

// 예약글팝업
function reFormPop() {
  window.open('/reForm','reForm','scrollbars=yes,width=400,height=370,left=300,top=300');
}


// 플래쉬삽입(IE ActivX Patch Virson )
...
function flashGallery(url,w,h,id,bg,vars,win,me){
	var flashStrGly=
	"<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0' width='"+w+"' height='"+h+"' id='"+id+"' align='middle'>"+
	"<param name='allowScriptAccess' value='always' />"+
	"<param name='movie' value='"+url+"' />"+
...
window.onscroll = function(){
    if(document.getElementById("divQuickTop") != null){
        ...
        if (scrollTop == 0)
        {
            QuicknewPos = 300 + document.body.scrollTop;
        }
        else{
            QuicknewPos = scrollTop + 300;
        }
